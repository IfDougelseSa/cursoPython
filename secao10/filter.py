...
# Blibioteca para trabalhar com dados estatísticos
import statistics
...
#OBS: Assim como na função map(), após serem utilizados os dados de filter(), eles são excluídos da
# memória.
...
# Devemos criar uma lista contendo 'Sua instrutora é + nome, desde que cada nome tenha menos de 5
# caracteres
