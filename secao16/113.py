...
- POO é um paradigma de programação que utiliza mapeamento de objetos do mundo real para modelos
computacionais.
...
- Classe -> Modelo do objeto do mundo real sendo representado compultacionalmente;
