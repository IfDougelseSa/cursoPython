...
Este é só mais um parâmetro, mas diferente do *arg que coloca os valores extras
...
print(cumprimento_especial(geek='Ola'))
...
# OBS! Os nomes da chave em um dicionário devem ser o mesmo dos parâmetros de uma função
